  ...
  <div class="flex shadow-md">
    ...
    <div class="flex flex-wrap content-center justify-center rounded-l-md bg-white" style="width: 24rem; height: 32rem;">
      <div class="w-72">
        ...
        <small class="text-gray-400">Please enter your admin details</small>
      ...
      <?php endif; ?> -->
          <div class="mb-3">
            <label class="mb-2 block text-xs font-semibold">Admin Id</label>
            <input type="text" placeholder="Enter your Admin Id" class="block w-full rounded-md border border-gray-300 focus:border-purple-700 focus:outline-none focus:ring-1 focus:ring-purple-700 py-1 px-1.5 text-gray-500" />
          </div>
